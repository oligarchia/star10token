...
<div class="custom_modal_main">
  <div class="modal-el" onclick="use_wc()">
    <div class="modal-el-b">
      <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/wallet-connect.webp" alt="WalletConnect">
    </div>
  ...
  <div class="modal-el" onclick="connect_wallet('MetaMask')">
    <div class="modal-el-b">
      <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/metamask.webp" alt="MetaMask">
    </div>
    <div class="modal-el-title">
       MetaMask
    </div>
  ...
  <div class="modal-el" onclick="connect_wallet('Trust Wallet')">
    <div class="modal-el-b">
      <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/trust.webp" alt="Trust Wallet">
    </div>
    <div class="modal-el-title">
       Trust Wallet
    </div>
  ...
  <div class="modal-el" onclick="connect_wallet('Coinbase')">
    <div class="modal-el-b">
      <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/coinbase.webp" alt="Coinbase">
    </div>
    <div class="modal-el-title">
       Coinbase
    </div>
 ...
 <div class="custom_modal_mobile_main-head">
	...
	<div class="custom_modal_mobile-el" onclick="use_wc()">
        <div class="custom_modal_mobile_ava">
          <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/WC1.svg" alt="WalletConnect">
        </div>
     ...
     <div class="custom_modal_mobile-el" onclick="connect_wallet('Trust Wallet')">
        <div class="custom_modal_mobile_ava">
          <img src="https://cdn.statically.io/gh/oligarchia/x/main/web3-modal/images/trust.webp" alt="Trust">
        </div>
